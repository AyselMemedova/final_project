...
//   useEffect(() => {
//     localStorage.setItem('wishlistForDiplomWork', JSON.stringify(wishlist));
//   }, [wishlist]);

//   return (
//     <MainContext.Provider
//       value={{ data, setData, loading, setLoading, error, setError, basket, setBasket, wishlist, setWishlist }}
//     >
//       <RouterProvider router={router} />
//     </MainContext.Provider>
//   );
